...
# Character Profiler 1.1.4 Release Checklist
...
**Current stable metadata:** 1.1.2 build 19, iOS 17+, SwiftData schema unchanged from the 1.0/1.1 line, archive format v1.
